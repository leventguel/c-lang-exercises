...
//% Integer partitions into odd parts as non-decreasing list of parts.
//% Same as: compositions into non-decreasing odd parts.
//% Cf. OEIS sequence A000009.

// Cf. comb/partition-odd-desc-demo.cc for partitions into odd parts as non-increasing lists
