...
//% Integer partitions into odd parts as non-increasing list of parts.
...
// Cf. comb/partition-odd-asc-demo.cc for partitions into odd parts as non-decreasing lists
