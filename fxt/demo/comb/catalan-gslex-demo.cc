...
//% Catalan restricted growth strings (RGS) and parentheses strings in gslex order.

// Cf. comb/catalan-subset-lex-demo.cc for subset-lex order
...
/// MyRelDir: "demo/comb"
/// makefile-dir: "../../"
/// make-target: "1demo DSRC=demo/comb/catalan-gslex-demo.cc"
/// make-target2: "1demo DSRC=demo/comb/catalan-gslex-demo.cc DEMOFLAGS=-DTIMING"
/// End:
